...
# 
# Next we consider an option to make a capital improvement in the gold mine following an [analysis of Martin Haugh](http://www.columbia.edu/~mh2078/FoundationsFE/RealOptions.pdf). The option increases the gold output by 25% to 12,500 oz./year. The required investment is a \$4 million capital expense and an on-going increase in operating costs from \$200/oz. to \$240/oz. There would be no residual value resulting from the investment. The task is to determine if this option has value and, if so, how the option should be implemented.
# 
